...
export type StrictModeConfig = Message<"qdrant.StrictModeConfig"> & {
   ...
   *
   * @generated from field: optional uint32 max_resident_memory_percent = 21 [deprecated = true];
   * @deprecated
   */
